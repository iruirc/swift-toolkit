...
3. Never allow direct instantiation — always inject via the project's DI framework.
4. Decide async strategy: RxSwift, Combine, or async/await (see CLAUDE.md for preferred approach).
...
3. Define service interfaces (protocols) and their DI registrations.

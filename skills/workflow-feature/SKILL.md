...
Единственное согласование, которое всегда требуется независимо от режима — финальный коммит, если оркестратор инициирует commit-flow. Это тоже ответственность оркестратора, не workflow-feature.
